...
import 'package:medisync/feature/presentation/pages/add_medicate/widgets/time_container_widget.dart';
...
class AddMedicatePage extends StatefulWidget {
  const AddMedicatePage({super.key});

  @override
  State<AddMedicatePage> createState() => _AddMedicatePageState();
}

class _AddMedicatePageState extends State<AddMedicatePage> {
  ...
  _createMedication() async {
    if (selectedTimes.isNotEmpty && selectedDays.isNotEmpty) {
      if (_formKey.currentState!.validate()) {
        String uId = (DateTime.now().microsecond * DateTime.now().microsecond)
            .toString();
        ...
        Navigator.pop(context);
        // show toast
        toast(msg: S.of(context).createdSuccessfully);
      }
    } else {
      toast(
